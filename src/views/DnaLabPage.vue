<template>
  <div class="dna-lab-page relative w-full min-h-screen overflow-hidden">
    <!-- Background -->
    ...
    <div class="relative z-10 flex flex-col h-full min-h-screen">
      ...
      <div class="flex items-center justify-between px-4 pt-4 pb-6">
        ...
        <h1 class="text-title2 font-semibold text-white">DNA Lab</h1>
...
import CharacterConfiguratorSection from "../components/CharacterConfiguratorSection.vue";
